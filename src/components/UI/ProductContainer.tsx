...
export default function ProductContainer({ key, title, description, image }: ProductContainerProps) {
  return (
      <div key={key} className="group relative w-full h-[400px] bg-cover bg-center rounded-3xl overflow-hidden cursor-pointer shadow-[0_6px_15px_rgba(0,0,0,0.08)] hover:shadow-[0_10px_25px_rgba(0,0,0,0.12)] transition-all duration-500 ease-out" style={{ backgroundImage: `url(${image})` }}>
        ...
        <article className="absolute inset-0 flex flex-col items-center justify-end text-white transition-all duration-500 ease-out group-hover:justify-center">
          ...
          <div className="relative z-10 flex flex-col lg:flex-col-reverse group-hover:flex-col items-center pb-5 lg:pb-0">
