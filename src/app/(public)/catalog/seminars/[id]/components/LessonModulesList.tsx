...
export default function LessonModules({ modules } : ModulesAccordionProps) {
  return (
    <Accordion type="single" collapsible className="w-full border border-[#2A2A2A] rounded-md bg-[#1a1a1a] p-5">
          ...
          <AccordionContent className="pb-4">
            <div className="flex flex-col gap-6 mt-2">
              {module.lessons.map((lesson, lessonIndex) => (
                <div key={lessonIndex} className="flex items-center pl-4 gap-4 border-l border-l-[#FF7A00]/15">
                  <div
                    className="
