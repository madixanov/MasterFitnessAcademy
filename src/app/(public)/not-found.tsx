...
export default function NotFoundPage() {
  ...
  return (
    <div className="bg-[url('/courses/bg-photo.png')] bg-center bg-cover bg-no-repeat min-h-[calc(100vh-140px)] flex items-center justify-center">
      ...
      <MainContainer>
        <div className="relative w-full flex flex-col items-center text-center text-white px-4">
          ...
          <div className="relative z-10 py-20 flex flex-col items-center gap-6 animate-fadeIn">
            ...
            <p className="text-2xl uppercase opacity-90">
              страница не найдена
            </p>
